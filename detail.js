...
let detail = document.getElementById("recipeItem");
  ...
  <div class="recipe-container">
    ...
    <div class="recipe-content">
      ...
      <div class="info-row">
        ...
        <span><b>Rating:</b> ${recipe.rating}</span>
        <span><b>Cuisine:</b> ${recipe.cuisine}</span>
      </div>

      <div class="info-row">
        <span><b>Calories:</b> ${recipe.caloriesPerServing}</span>
        <span><b>Reviews:</b> ${recipe.reviewCount}</span>
        <span><b>Meal Type:</b> ${recipe.mealType}</span>
      </div>
